...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, TextInput, Alert, Modal, FlatList, Switch } from 'react-native';
                        ...
                        <View key={field.id} style={styles.fieldCard}>
                            ...
                            <View style={styles.controls}>
                                ...
                                <TouchableOpacity onPress={() => moveField(index, 'down')} disabled={index === fields.length - 1}>
                                    <Ionicons name="chevron-down" size={24} color={index === fields.length - 1 ? '#333' : '#666'} />
                                </TouchableOpacity>
                            </View>
                        </View>
                    ))
                            ...
                            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.typeScroll}>
                                {FIELD_TYPES.map(t => (
                                    ...
                                    >
                                        ...
                                        />
                                        <Text style={[styles.typeText, newFieldType === t.value && styles.typeTextActive]}>
                                            {t.label}
                                        </Text>
                                    </TouchableOpacity>
                                ))}
...
const getStyles = (theme) => StyleSheet.create({
    ...
    saveBtn: { backgroundColor: theme.colors.primary, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 24 },
    ...
    fieldHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
    ...
    badgeText: { fontSize: 13, color: '#AAA', fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 },

    badgeRequired: { backgroundColor: '#3A1515' }, // Dark Red bg
    badgeTextRequired: { color: '#FF4444' }, // Bright Red text

    optionsText: {
        color: '#888', fontSize: 13, marginTop: 16,
        fontStyle: 'italic', paddingLeft: 12, borderLeftWidth: 2, borderLeftColor: '#333'
    },
    ...
    fab: {
        ...
        backgroundColor: '#FF9F0A', width: 64, height: 64, borderRadius: 32, // Orange accent
        justifyContent: 'center', alignItems: 'center',
        shadowColor: "#FF9F0A", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 8
    },
    ...
    label: { fontSize: 13, fontWeight: '700', color: '#888', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1 },
    ...
    presetChip: {
        ...
        backgroundColor: '#222', marginRight: 10,
        borderWidth: 1, borderColor: '#333'
    },
    ...
    addBtn: { backgroundColor: '#FF9F0A', padding: 20, borderRadius: 18, alignItems: 'center', marginTop: 10 },
